...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Cinematic motion, editorial video, and digital experiences by SWORT." },
      { name: "author", content: "SWORT" },
      { property: "og:site_name", content: "SWORT" },
